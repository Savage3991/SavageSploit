...
typedef struct Proto
{
    ...
    p_member1_enc<TValue*> k,              // constants used by the function
    p_member1_enc<Instruction*> code,      // function bytecode
    p_member1_enc<struct Proto**> p,       // functions defined inside the function
...
typedef struct LuaTable
{
    ...
    LUAVM_SHUFFLE4(LUAVM_SHUFFLE_OTHER,
    t_meta_enc<struct LuaTable*> metatable,
    t_member_enc<TValue*> array,  // array part
    t_member_enc<LuaNode*> node,
    GCObject* gclist);
} LuaTable;
// clang-format on
